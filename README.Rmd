...
The core theme, `theme_ewen`, uses Arial Narrow which should be installed on practically any modern system. Variations on this theme use widely available typefaces e.g. [Work Sans](https://github.com/weiweihuanghuang/Work-Sans) by Wei Huang.
