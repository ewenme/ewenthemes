...
Typography-centric themes and theme components for ggplot2. Standing on the shoulders of [hrbrthemes](https://github.com/hrbrmstr/hrbrthemes). 

The core theme, `theme_ewen`, uses Arial Narrow which should be installed on practically any modern system. Variations on this theme use widely available typefaces - [Work Sans](https://github.com/weiweihuanghuang/Work-Sans) by Wei Huang, and [Spectral](https://fonts.google.com/specimen/Spectral) by Production Type.
...
- `font_ws_extra_light`: a short global alias for "`Work Sans ExtraLight`"
